      ...
      {showForm && (
        <div className="mb-4 space-y-3 rounded-lg border border-slate-200 bg-slate-50 p-4">
          ...
          <select
            ...
            className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
          >
            <option value="parking">{AMENITY_LABELS.parking}</option>
            <option value="camping">{AMENITY_LABELS.camping}</option>
            <option value="medical">{AMENITY_LABELS.medical}</option>
            <option value="lost-found">{AMENITY_LABELS["lost-found"]}</option>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({ ...formData, setupCost: parseInt(e.target.value) })
            }
            className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm"
          />
          <input
